...
$("#btnDeleteCustomer").click(function () {
    ...
    $.ajax({
        url: "http://localhost:8080/BackEnd/customer?CusID=" + customerID,// viya query string
        method: "DELETE",
...
$("#btnCustomerSearch").click(function () {
    ...
    $.ajax({
        url: "http://localhost:8080/BackEnd/customer?option=SEARCH&searchCustomerID="+searchID,
        method: "GET",
        success: function (res) {
            if (res.status == 200) {
